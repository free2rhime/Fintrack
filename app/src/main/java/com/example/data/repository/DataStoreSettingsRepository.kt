...
class DataStoreSettingsRepository(private val context: Context) : SettingsRepository {
    ...
    override val filterSettingsFlow: Flow<FilterSettings> = context.dataStore.data.map { prefs ->
        FilterSettings(
    ...
    override val themeModeFlow: Flow<String> = context.dataStore.data.map { prefs ->
